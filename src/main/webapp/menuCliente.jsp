...
<body>
    <header>
        <div class="inicio">
            ...
            <p>Hola, ${nombreCliente} ${apellidoCliente}</p>
        </div>
        <div class="perfil">
    ...
    <main>
        <div class="saldo">
            ...
            <div class="saldoInferior">
                <%
                    Double saldoDisponible = (Double) request.getAttribute("saldoDisponible");
                    if (saldoDisponible != null) {
                        out.print("<p>$ " + String.format("%.2f", saldoDisponible) + "</p>");
                    } else {
                        out.print("<p class='error-message'>No se pudo obtener el saldo o no hay cuenta asociada.</p>");
                    }
                %>
